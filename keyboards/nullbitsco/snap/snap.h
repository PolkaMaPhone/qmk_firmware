...
#ifdef VIA_ENABLE
enum custom_keycodes { DISC_MUTE = QK_USER_0, ENC_RGB_TOG = SAFE_RANGE, SUPER_ALT_TAB };
#else
enum custom_keycodes { DISC_MUTE = SAFE_RANGE, ENC_RGB_TOG = SAFE_RANGE, SUPER_ALT_TAB };
#endif
